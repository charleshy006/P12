...
let User = {
    ...
    game_score_lishi:{type: Number, default: 0}, //历史最高得分
    ...
    planeName:{type: mongoose.Schema.Types.Mixed, default: app.Configs.config_planeName},//等级
    petName:{type: mongoose.Schema.Types.Mixed, default: app.Configs.config_planeName},//等级
    ...
    plane:{type: mongoose.Schema.Types.Mixed, default: app.Configs.config_Plane},//等级
